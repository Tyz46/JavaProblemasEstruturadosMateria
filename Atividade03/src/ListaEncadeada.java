public class ListaEncadeada {
    ...
    public void insereElemento(int elemento) {
        ...
        if (inicio == null) { // Caso a lista esteja vazia, o início aponta para o novo nó
            inicio = novoNo;
    ...
    // Metodo para exibir os elementos da lista (para teste)
